...
$user = query("SELECT * FROM  daftarkode WHERE used='belum' ORDER BY kelas");
...
<div class="columns">
  <ul class="price">
    ...
    <a href="kode.php"><button style="width:auto;background-color:#002D40;">Reset</button></a>
    <a href="sudah.php"><button style="width:auto;background-color:#002D40;">Sudah Vote</button></a>
    <li>
